...
const ProFeaturesList: React.FC = (props) => {
    return (
        <ul className="ms-pro-features-list">
            ...
            <li className="ms-pro-features-list__item">
                <span className="ms-pro-features-list__icon">{mondoTranslate('pro.features_list.icon_5')}</span>
                <span className="ms-pro-features-list__text">{mondoTranslate('pro.features_list.text_5')}</span>
            </li>
            {/*  <li className="ms-pro-features-list__item">
