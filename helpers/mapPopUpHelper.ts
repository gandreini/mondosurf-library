...
export function createPopUpWeb(feature: any, layer: any, router: any): void {
    let mondoLeafletPopup = `<a id="ms_map_popover_${feature.properties.id}" class="ms-map-tooltip__content" href="/surf-spot/${feature.properties.sg}/guide/${feature.properties.id}">`;
