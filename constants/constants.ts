...
export const STRIPE_YEARLY_SUBSCRIPTION_PRICE = "€ 19.99";
export const STRIPE_MONTHLY_SUBSCRIPTION_PRICE = "€ 1.99";
export const IOS_DEFAULT_YEARLY_SUBSCRIPTION_PRICE = "€ 19.99"; // Used when the real price hasn't been loaded yet.
...
export const APP_LATEST_VERSION = "4.8.0";
export const APP_LATEST_VERSION_PROGRESSIVE = 55;
