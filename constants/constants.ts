...
export const YEARLY_SUBSCRIPTION_TITLE = "Mondo Pro Yearly";
export const MONTHLY_SUBSCRIPTION_TITLE = "Mondo Pro Monthly";
...
export const APP_LATEST_VERSION = "4.15.0";
export const APP_LATEST_VERSION_PROGRESSIVE = 65;
